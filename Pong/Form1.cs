...
namespace Pong
{
    public partial class Form1 : Form
    {
        ...
        int ballx = 5; // horizontal X value for ball object
        ...
        {
            // this is the main event, this event will trigger every 20 milliseconds
            playerScore.Text += "" + score; // display player score on label 1
            ...
            cpu.Top += speed; // assign the CPU top speed integer

            if (score < 5)
            {
                // then do the following

                // if CPU has reached the top or the bottom of the screen
            ...
            else
            {
                ...
                // allowing the CPU to follow the ball so it doesn't miss
                cpu.Top = ball.Top + 30;
            }
